...
const Page2 = () => {
  ...
  return (
    <div className='overflow-hidden pt-6 md:pt-6'>
      <h3 className='font-[anzo] text-xl py-32 text-center text-gray-400'>© Shashiraj 2026</h3>
      ...
      <div className='h-1 w-1/3 mx-auto bg-white mt-10 md:mb-20' ></div>
    </div>
  )
}
