...
const Page4 = () => {
  return (
    <div id="projects">
      ...
      <div className="mt-8 p-8 md:flex lg:justify-around">
        <div className="lg:w-1/3 flex justify-center items-center gap-2 flex-col bg-gray-100 p-4 m-4 rounded-lg shadow-lg">
